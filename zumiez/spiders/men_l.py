...
class MenLSpider(scrapy.Spider):
    name = "men-l"
    custom_settings = {
...
#             yield scrapy.Request(
#        
#              url = 'https://emiratesbd.ae/UAE/list/gyneacologist/n-0-2006' ,
    ...
    async def parse(self, response):
        ...
        try :
            for i in range (1,21):
                lnk = response.xpath(f'//*[@id="listar-content"]/div/div[2]/div/div/div[3]/div[{i}]/div/h3/a/@href').get()
                yield{
                    'link' : lnk ,
                }
